...
var ReactWrapper = function () {
  function ReactWrapper(nodes, root) {
    ...
    if (!root) {
      this.renderer = (0, _Utils.getAdapter)(options).createRenderer((0, _object2['default'])({ mode: 'mount' }, options));
      var ReactWrapperComponent = (0, _ReactWrapperComponent2['default'])(nodes, options);
      this.renderer.render(_react2['default'].createElement(ReactWrapperComponent, {
      ...
      var _getFromRenderer = getFromRenderer(this.renderer),
          component = _getFromRenderer.component,
          node = _getFromRenderer.node;
    ...
    this.complexSelector = new _ComplexSelector2['default'](_RSTTraversal.buildPredicate, findWhereUnwrapped, _RSTTraversal.childrenOfNode);
  }
  ...
  _createClass(ReactWrapper, [{
    ...
    value: function () {
      function update() {
        ...
        this.single('update', function () {
          var _getFromRenderer2 = getFromRenderer(_this.renderer),
              component = _getFromRenderer2.component,
              node = _getFromRenderer2.node;
    ...
    value: function () {
      function setProps(props) {
        ...
        this.component.setChildProps(props, function () {
          _this4.update();
          callback();
        });
        return this;
    ...
    value: function () {
      function matchesElement(node) {
        ...
        return this.single('matchesElement', function () {
          return (0, _Utils.nodeMatches)(node, _this6.getNodeInternal(), function (a, b) {
            return a <= b;
          });
        });
      }
    ...
    value: function () {
      function is(selector) {
        var predicate = (0, _RSTTraversal.buildPredicate)(selector);
    ...
    value: function () {
      function html() {
        ...
        return this.single('html', function (n) {
          ...
          var adapter = (0, _Utils.getAdapter)(_this10.options);
    ...
    value: function () {
      function simulate(event) {
        ...
        this.single('simulate', function (n) {
          _this11.renderer.simulateEvent(n, event, mock);
          _this11.root.update();
        });
        return this;
      }
    ...
    value: function () {
      function parents(selector) {
        ...
        var allParents = this.wrap(this.single('parents', function (n) {
          return (0, _RSTTraversal.parentsOfNode)(n, _this15.root.getNodeInternal());
        }));
