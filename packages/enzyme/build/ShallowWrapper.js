...
var ShallowWrapper = function () {
  function ShallowWrapper(nodes, root) {
    ...
    if (!root) {
      ...
      this.renderer = (0, _Utils.getAdapter)(options).createRenderer((0, _object2['default'])({ mode: 'shallow' }, options));
  ...
  _createClass(ShallowWrapper, [{
        ...
        this.single('rerender', function () {
          (0, _Utils.withSetStateAllowed)(function () {
            ...
            _this2.renderer.batchedUpdates(function () {
              ...
              if (_this2.options.lifecycleExperimental && instance && typeof instance.componentWillReceiveProps === 'function') {
              ...
              if (_this2.options.lifecycleExperimental && instance && typeof instance.shouldComponentUpdate === 'function') {
              ...
              if (shouldRender) {
                if (props) _this2.unrendered = _react2['default'].cloneElement(_this2.unrendered, props);
                ...
                if (_this2.options.lifecycleExperimental && instance && typeof instance.componentDidUpdate === 'function') {
    ...
    value: function () {
      function setState(state) {
        ...
        if (this.instance() === null || (0, _Utils.isFunctionalComponent)(this.instance())) {
          throw new Error('ShallowWrapper::setState() can only be called on class components');
        }
        this.single('setState', function () {
          (0, _Utils.withSetStateAllowed)(function () {
            _this3.instance().setState(state, callback);
            _this3.update();
          });
        });
        return this;
